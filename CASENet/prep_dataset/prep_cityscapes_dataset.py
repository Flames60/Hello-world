...
def get_dataloader(args):
    ...
    root_img_folder = "/home/gongweibo/segmentation/CASENet-1-master/cityscapes-preprocess/data_proc" 
    root_label_folder = "/home/gongweibo/segmentation/CASENet-1-master/cityscapes-preprocess/data_proc"
    train_anno_txt = "/home/gongweibo/segmentation/CASENet-1-master/cityscapes-preprocess/data_proc/train.txt"
    val_anno_txt = "/home/gongweibo/segmentation/CASENet-1-master/cityscapes-preprocess/data_proc/val.txt"
    train_hdf5_file = "/home/gongweibo/segmentation/CASENet-1-master/utils/train_label_binary_np.h5"
    val_hdf5_file = "/home/gongweibo/segmentation/CASENet-1-master/utils/val_label_binary_np.h5"

    input_size = 480 #480 #472
    ...
    val_loader = torch.utils.data.DataLoader(
        val_dataset, batch_size=args.batch_size//4, shuffle=False,  #/2  
        num_workers=args.workers, pin_memory=True)
