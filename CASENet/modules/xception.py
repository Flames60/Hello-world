...
model_urls = {
    'xception': '/home/gongweibo/.torch/models/xception-43020ad28.pth'#'http://data.lip6.fr/cadene/pretrainedmodels/xception-b5690688.pth'
}
...
class Xception(nn.Module):
    ...
    def forward(self, input):
        ...
        x = self.block3(x)
        self.layers.append(self.block3.hook_layer)  # for me
        x = self.block4(x)
        x = self.block5(x)
        x = self.block6(x)
        x = self.block7(x)
